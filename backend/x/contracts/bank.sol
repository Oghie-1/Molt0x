...
//Bank is smart contract that allows a user to deposit, withdraw and save ETH!!
...
contract Bank{
  ...
  function userAccountBalance() public view returns(uint){
        console.log("Balance:", userAccount[msg.sender]);
      return userAccount[msg.sender];
  }
  
  function accountExist() public view returns(bool){
        console.log("User Exists:", userExists[msg.sender]);
